...
public class ThreeStoryFragment extends Fragment {
    private RecyclerView rcvThreeStory;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (R.layout.fragment_one_story == 0) {
            ...
            View view = inflater.inflate(R.layout.fragment_three_story, container, false);
            initView(view);
            callApiGetData(3);
            return view;
        }
    ...
    public void initView(View view) {
        rcvThreeStory = view.findViewById(R.id.rcvThreeStory);
        ...
        Callback<List<Story>> callback = new Callback<List<Story>>() {
            ...
            public void onResponse(Call<List<Story>> call, Response<List<Story>> response) {
                if (response.body() == null || response.body().size() == 0) {
                    ...
                    storyAdapter = new StoryAdapter(getActivity(), stories,"Hành động");
                    ...
                    rcvThreeStory.setLayoutManager(new LinearLayoutManager(getActivity()));
                    rcvThreeStory.setAdapter(storyAdapter);
                }
            }
